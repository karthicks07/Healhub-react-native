    ...
    return (
      ...
      <View style={styles.maincontainer}>
        ...
        <View style={styles.doctorprofile}>
          <Image source={require('../assets/pics/wang.png')} style={styles.doctorpic}/>
          <View style={{ height: 15 }} />
          <Text style={{fontSize:22,color:'#222B45'}}>Dr. Wang Y</Text>
          <Text style={{fontSize:16,color:'#6B779A'}}>Orthopedic Surgeon</Text>
          <View style={{ height: 15 }} />
          <View style={styles.batches}>
              ...
              <View style={styles.batch01}>
                ...
                <View style={{ height: 10 }} />
                <Text style={{fontSize:18,color:'#222B45'}}>4.5</Text>
