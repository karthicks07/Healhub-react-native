    ...
    return (
      ...
      <View style={styles.maincontainer}>
        ...
        <View style={styles.doctorprofile}>
          <Image source={require('../assets/pics/klimisch.png')} style={styles.doctorpic}/>
          <View style={{ height: 15 }} />
          <Text style={{fontSize:22,color:'#222B45'}}>Dr. Klimisch J</Text>
          <Text style={{fontSize:16,color:'#6B779A'}}>Cardiologist</Text>
          <View style={{ height: 15 }} />
          <View style={styles.batches}>
              <View style={styles.batch01}>
                <Image source={require('../assets/pics/batch1.png')} style={styles.batch1}/>
                <View style={{ height: 10 }} />
                <Text style={{fontSize:18,color:'#222B45'}}>900+</Text>
                <Text style={{fontSize:16,color:'#6B779A'}}>Patients</Text>
              </View>
              <View style={styles.batch01}>
                <Image source={require('../assets/pics/batch2.png')} style={styles.batch1}/>
                <View style={{ height: 10 }} />
                <Text style={{fontSize:18,color:'#222B45'}}>7 Yrs</Text>
