    ...
    return (
      ...
      <View style={styles.maincontainer}>
        ...
        <View style={styles.doctorprofile}>
          <Image source={require('../assets/pics/martinez.png')} style={styles.doctorpic}/>
          <View style={{ height: 15 }} />
          <Text style={{fontSize:22,color:'#222B45'}}>Dr. Martinez K</Text>
