    ...
    return (
      ...
      <View style={styles.maincontainer}>
        ...
        <View style={styles.doctorprofile}>
          <Image source={require('../assets/pics/lee.png')} style={styles.doctorpic}/>
          <View style={{ height: 15 }} />
          <Text style={{fontSize:22,color:'#222B45'}}>Dr. Lee A</Text>
          <Text style={{fontSize:16,color:'#6B779A'}}>Neurologist</Text>
          <View style={{ height: 15 }} />
