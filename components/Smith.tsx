    ...
    return (
        ...
        <View style={styles.maincontainer}>
          ...
          <View style={styles.doctorprofile}>
            <Image source={require('../assets/pics/smith.png')} style={styles.doctorpic}/>
            <View style={{ height: 15 }} />
            <Text style={{fontSize:22,color:'#222B45'}}>Dr. Smith W</Text>
            ...
            <View style={styles.batches}>
              ...
              <View style={styles.batch01}>
                ...
                <View style={{ height: 10 }} />
                <Text style={{fontSize:18,color:'#222B45'}}>4.8</Text>
          ...
          <View style={styles.details}>
            ...
            <View style={styles.communication}>
              <TouchableOpacity onPress={() => Whatsapp(`whatsapp://send?phone=${9876543210}`)}>
